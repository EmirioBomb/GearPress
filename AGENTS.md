...
- Keep Body lines real and concise. Add `Co-authored-by` trailers only for people or Agents who materially contributed to the current commit, using the project-approved identities in `.agents/skills/conventional-commit/SKILL.md`.
